...
cd "/home/gzu5140/Keerthana_b1042/grnInference/code/TwINFER/saturation_effects/"

echo "[$(date)] Starting simulation ..."
~/.conda/envs/twinfer-code/bin/python -u mutliple_k_add_A_to_B.py --config_index $((${SLURM_ARRAY_TASK_ID:-0}))
status=$?
