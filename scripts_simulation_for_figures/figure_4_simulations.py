...
path_to_output = "/home/gzu5140/Keerthana_b1042/grnInference/simulation_data/figure_4/"
...
base_configs = [
    {
        ...
        "log_file": f"{path_to_output}/figure_4.log",  # Name of the network used -- will be in the filename
        "log_pi_on": False,
    ...
    },
    {
        ...
        "log_pi_on": False,
        "multiple_interaction_type": "additive",
        "type": "Mutual_regulation",  # Name of the network used -- will be in the filename
        "number_of_parallel_parameters": 1, #Number of parameters to be run in parallel
        "number_of_cores_per_parameter": 48, #Number of cores to be used per parameter (number_of_parallel_parameters * number_of_cores_per_parameter = number of cores in your computer)
    }
]
