...
path_to_output_folder = "/home/gzu5140/Keerthana_b1042/grnInference/simulation_data/hsc_folder/"
# ==========================================================
    ...
    # # ---------- CONFIG 0 ----------
     {
        ...
        "path_to_connectivity_matrix": "/home/gzu5140/Keerthana_b1042/grnInference/simulation_data/hsc_folder/HSC_network.txt", #path to the connectivity matrix specifying the GRN to simulate
        "param_csv": f"/home/gzu5140/Keerthana_b1042/grnInference/simulation_data/hsc_folder/median_parameter.csv", #Path to the parameters for all genes and interaction terms
        "rows_to_use": [[0]*11],
        "output_folder": f"{path_to_output_folder}",
        "log_file": f"{path_to_output_folder}/hsc_network.jsonl",
        "type": "hsc_network_additive",
    ...
    },
     {
        ...
        "output_folder": f"{path_to_output_folder}",
        "log_file": f"{path_to_output_folder}/hsc_network.jsonl",
        "type": "hsc_network_and",
        "combinatorial_interaction_type": "AND",
        "number_of_parallel_parameters": 1,
        "number_of_cores_per_parameter": 56,
        "log_pi_on": False,
    }
